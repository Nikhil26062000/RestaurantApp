      ...
      <footer className="relative z-10 bg-black text-white pt-20 pb-10 lg:pt-[120px] lg:pb-20">
        <div className="container w-10/12 m-auto">
          <div className="flex flex-wrap -mx-4">
            ...
            <LinkGroup className="text-yellow-600" header="Company">
            ...
            <LinkGroup header="Legal">
              ...
              <NavLink className="text-yellow-600" link="/#" label="Cookie Policy" />
              <NavLink className="text-yellow-600" link="/#" label="Privacy Policy" />
            </LinkGroup>
            <LinkGroup header="Quick Links">
              <NavLink className="text-yellow-600" link="/#" label="Help & Support" />
              <NavLink className="text-yellow-600" link="/#" label="Our Services" />
              <NavLink className="text-yellow-600" link="/#" label="Partner with us" />
            </LinkGroup>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <div className="flex items-center mb-6">
                  <a
                    href="/#"
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-yellow-600  hover:text-yellow-600 sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width={8}
                      height={16}
                  ...
                  <a
                    href="/#"
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-yellow-600  hover:text-yellow-400 sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width={16}
                      height={12}
